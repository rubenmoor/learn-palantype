...
exercise2 =
    exercise
        ...
        (\_ -> elClass "div" "paragraph" $ do
              ...
              text " and the "
              el "code" $ text "ʃ"
              text " key, the s in the coda is out of reach. Luckily we can use \
                   \the (small) "
              el "code" $ text "s"
        ...
        PatSmallS
        (\_ -> elClass "div" "paragraph" $ do
              text "This extra key will give us some flexibility when dealing \
                   \with "
              el "em" $ text "-st"
              text ", "
              el "em" $ text "-ds"
...
exercise5 =
    exercise
        ...
        ( \_ -> elClass "div" "paragraph" $ do
              ...
              el "em" $ text "ö"
              text " already uses two keys and its stretched version doesn't \
...
exercise6 =
    exercise
        ...
        (\lang -> elClass "div" "paragraph" $ do
              ...
              el "em" $ text "t"
              text " in the patterns disturb you. There is a simple reason: \
              ...
              text " key twice for "
              el "em" $ text "rrt"
              text ", which is impossible, at least without some explicit rule. \
...
exercise9 =
    exercise
        ...
        PatDiphtong
        (\_ -> elClass "div" "paragraph" $ do
              text "If those seemed weird to you, that's because they are weird. \
...
exercise11 =
    exercise
        ...
        (\_ -> elClass "div" "paragraph" $ do
              ...
              el "em" $ text "-ig"
              text ", the idea being that the stretch key is used for \
...
exercise12 =
    exercise
        ...
        (\_ -> elClass "div" "paragraph" $ do
              ...
              text ": Use "
              el "code" $ text "+S"
              text " in order to type it. There is another aspect you will \
        ...
        (\_ -> elClass "div" "paragraph" $ do
              ...
              el "code" $ text "GFW"
              text " is there just in case. It is used in fingerspelling for \
                   \example."
        )
...
exercise13 =
    exercise
        5
        (\_ -> elClass "div" "paragraph" $ do
              text "This rule increase efficiency for vowel-heavy words. \
                   \Using "
              el "code" $ text "J"
              text " for "
              el "em" $ text "i"
              text " saves you from breaking up a word and adding an extra chord \
                   \just for one vowel."
        )
        PatIJ
        (\_ -> elClass "div" "paragraph" $ do
              ...
              text " and the "
              el "em" $ text "i"
              text ". Those swaps are used sometimes to increase efficiency. \
